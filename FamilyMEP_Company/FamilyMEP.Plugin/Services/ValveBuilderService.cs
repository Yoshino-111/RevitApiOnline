...
internal static class ValveBuilderService
{
        ...
        ValveBuilderResult result)
    {
        ...
        if (request.PreserveSourceParameters)
        {
            ...
            int renamedParameterCount = RenameCompactParameters(manager);
            int renamedLookupCount = RenameLookupTables(
                familyDocument,
                manager,
                request.FamilyName,
                result);
            ...
            result.AppliedParameters.Add(
                $"{renamedParameterCount} custom parameters renamed to compact FT_* names");
            result.AppliedParameters.Add(
                $"{renamedLookupCount} lookup tables renamed with the Family name");
        }
        if (!request.PreserveSourceParameters)
        ...
        FamilyManager manager)
    {
        ...
        string[] materialParameterNames =
        [
            "Valve Material",
            "Operator Material",
            "Valve Body Material",
            "Valve Operator Material",
            "Body Material",
            "Handwheel Material",
            "Disc Material",
            "Seat Material",
    ...
    private static int RenameCompactParameters(FamilyManager manager)
    {
        ...
        [
            ...
            ("Center Axis to Top", "FT_LE_ZZ_CtrTop"),
            ("Gate Body Selection Length", "FT_LE_ZZ_GateSel"),
            ("Bonnet Class Selector Length", "FT_LE_ZZ_BonnetSel"),
            ("Valve Operator Selector Length", "FT_LE_ZZ_WheelSel"),
            ("Valve Operator Type Selector Length", "FT_LE_ZZ_WheelType"),
            ("Bonnet Flange Outside Radius", "FT_LE_ZZ_BonnetR"),
            ("Bonnet Flange Thickness", "FT_LE_ZZ_BonnetT"),
            ("Circumscribe Length", "FT_LE_ZZ_CircD"),
            ("Connection Center to Bonnet Flange", "FT_LE_ZZ_BonnetH"),
            ("Handwheel Stem Height", "FT_LE_ZZ_StemH"),
            ("Hex Length", "FT_LE_ZZ_HexL"),
            ("Female Thread Insertion Depth", "FT_LE_ZZ_ThreadD"),
            ("Female Thread Inside Radius", "FT_LE_ZZ_ThreadR"),
            ("Valve Body Angle", "FT_AN_ZZ_Body"),
            ("Valve Body Center Radius", "FT_LE_ZZ_BodyCR"),
            ("Valve Body Outside Radius", "FT_LE_ZZ_BodyOR"),
            ("Valve Body Horizontal Offset", "FT_LE_ZZ_BodyOff"),
            ("Valve Body Depth", "FT_LE_ZZ_BodyDepth"),
            ("Valve Body Width", "FT_LE_ZZ_BodyW"),
            ("Valve Drain Port Horizontal Offset", "FT_LE_ZZ_DrainOff"),
            ("Valve Drain Port Length", "FT_LE_ZZ_DrainL"),
            ("Valve Drain Port Radius", "FT_LE_ZZ_DrainR"),
            ("Valve Operator Selector Length A", "FT_LE_ZZ_WheelA"),
            ("Valve Operator Selector Length B", "FT_LE_ZZ_WheelB"),
            ("Valve Operator Selector Length C", "FT_LE_ZZ_WheelC"),
            ("Isometric Symbol Visibility", "FT_YN_ZZ_IsoSym"),
            ("Isometric Symbol Visibility (default)", "FT_YN_ZZ_IsoSym"),
            ("Plan Symbol Visibility", "FT_YN_ZZ_PlanSym"),
            ("Plan Symbol Visibility (default)", "FT_YN_ZZ_PlanSym"),
            ("Operator A Visibility", "FT_YN_ZZ_WheelA"),
            ("Operator B Visibility", "FT_YN_ZZ_WheelB"),
            ("Operator C Visibility", "FT_YN_ZZ_WheelC"),
            ("Symbol Length", "FT_LE_ZZ_SymL"),
            ("Tick Size", "FT_LE_ZZ_Tick"),
            ("Use Annotation Scale (default)", "FT_YN_ZZ_AnnoScale"),
            ("Overall Height", "FT_LE_ZZ_OverallH"),
            ("Overall Width", "FT_LE_ZZ_OverallW"),
            ("Valve Body Material", "FT_LE_ZZ_BodyMat"),
            ("Valve Operator Material", "FT_LE_ZZ_OpMat"),
            ("Body Material", "FT_LE_ZZ_BodyMat"),
            ("Handwheel Material", "FT_LE_ZZ_OpMat"),
            ("Disc Material", "FT_LE_ZZ_DiscMat"),
            ("Seat Material", "FT_LE_ZZ_SeatMat"),
            ("Seat Disc Material", "FT_LE_ZZ_SeatMat"),
            ("Stem Material", "FT_LE_ZZ_StemMat"),
            ("Valve Body Length", "FT_LE_ZZ_BodyL"),
            ("Center Axis to Operator Top", "FT_LE_ZZ_CtrTop"),
            ("Primary Connection to Handle Top", "FT_LE_ZZ_CtrTop"),
            ("Valve Overall Height", "FT_LE_ZZ_OverallH"),
            ("Valve Body Diameter", "FT_LE_ZZ_BodyD"),
            ("Valve Body Selector Length", "FT_LE_ZZ_BodySel"),
            ("Handwheel Type", "FT_LE_ZZ_WheelType"),
            ("Valve Plug End Offset", "FT_LE_ZZ_PlugEnd"),
            ("Valve Branch Offset", "FT_LE_ZZ_BranchOff"),
            ("Valve Hinge Horizontal Offset", "FT_LE_ZZ_HingeX"),
            ("Valve Hinge Depth", "FT_LE_ZZ_HingeD"),
            ("Valve Hinge Center Offset", "FT_LE_ZZ_HingeCtr"),
            ("Valve Plug Depth", "FT_LE_ZZ_PlugD"),
            ("Valve Plug Nut Depth", "FT_LE_ZZ_PlugNutD"),
            ("Valve Hinge Vertical Offset", "FT_LE_ZZ_HingeY"),
            ("Valve Branch Diameter", "FT_LE_ZZ_BranchD"),
            ("Valve Plug Diameter", "FT_LE_ZZ_PlugDia"),
            ("Valve Hinge Housing Diameter", "FT_LE_ZZ_HingeDia"),
            ("Valve Branch Angle", "FT_AN_ZZ_Branch"),
            ("Valve Plug Nut Width", "FT_LE_ZZ_PlugNutW"),
            ("Valve Nut Circumscribe Length", "FT_LE_ZZ_NutD"),
            ("Valve Nut Depth", "FT_LE_ZZ_NutDepth"),
            ("Valve Hinge Nut Offset", "FT_LE_ZZ_HingeNutOff"),
            ("Valve Hinge Nut Circumscribe Length", "FT_LE_ZZ_HingeNutD"),
            ("Overall Length", "FT_LE_ZZ_BodyL"),
            ("Body Sphere Outside Diameter", "FT_LE_ZZ_SphereD"),
            ("L1", "FT_LE_ZZ_L1"),
            ("L2", "FT_LE_ZZ_L2"),
            ("Octagon Width Across Flats", "FT_LE_ZZ_HexW"),
            ("Body Outside Diameter", "FT_LE_ZZ_BodyOD"),
        ...
        List<FamilyParameter> remaining = manager.Parameters
            .Cast<FamilyParameter>()
            .Where(parameter =>
                !parameter.Definition.Name.StartsWith("FT_", StringComparison.OrdinalIgnoreCase))
            .ToList();
        foreach (FamilyParameter parameter in remaining)
        {
            ...
            string candidate = MakeUniqueParameterName(
                $"FT_LE_ZZ_{suffix}",
                existingNames);
            try
            {
                manager.RenameParameter(parameter, candidate);
                existingNames.Remove(oldName);
            ...
            {
                // Built-in and protected parameters intentionally keep their Autodesk names.
            }
        }
        return renamedCount;
    }
    ...
    private static string CompactParameterSuffix(string name)
    {
        ...
        return suffix.Length <= 36 ? suffix : suffix[..36];
    }
        ...
        ValveBuilderResult result)
    {
        ...
        string familyPrefix = SanitizeLookupName(familyName);
        if (string.IsNullOrWhiteSpace(familyPrefix))
            familyPrefix = "ValveFamily";

        HashSet<string> occupied = new(
            oldNames.Where(name =>
                name.StartsWith(familyPrefix + "_", StringComparison.OrdinalIgnoreCase)),
            StringComparer.OrdinalIgnoreCase);
        var mappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
        foreach ((string oldName, int index) in oldNames.Select((name, index) => (name, index)))
        {
            if (oldName.StartsWith(familyPrefix + "_", StringComparison.OrdinalIgnoreCase))
                continue;
            string role = LookupTableRole(oldName, index + 1);
            string requested = $"{familyPrefix}_{role}";
            string newName = requested;
            int duplicate = 2;
            while (occupied.Contains(newName) || oldNames.Contains(newName, StringComparer.OrdinalIgnoreCase))
        ...
        try
        {
            foreach ((string oldName, string newName) in mappings)
            {
                string csvPath = Path.Combine(cacheFolder, $"{newName}.csv");
                if (!tableManager.ExportSizeTable(oldName, csvPath))
                {
                    result.Warnings.Add($"Lookup table '{oldName}' could not be exported for renaming.");
                    continue;
                }
                ...
                try
                {
                    ...
                    if (!tableManager.ImportSizeTable(familyDocument, csvPath, errorInfo))
                    {
                        throw new InvalidOperationException(
                    ...
                    {
                        string updated = parameter.Formula.Replace(
                            $"\"{oldName}\"",
                            $"\"{newName}\"");
                        manager.SetFormula(parameter, updated);
                    }
                    familyDocument.Regenerate();
                    if (!tableManager.RemoveSizeTable(oldName))
                        throw new InvalidOperationException("the original table could not be removed");
                    if (subTransaction.Commit() != TransactionStatus.Committed)
                        throw new InvalidOperationException("the lookup-table transaction did not commit");
                    renamed++;
                }
                catch (Exception exception)
                {
        ...
        finally
        {
            ...
            {
                // Temporary CSV files are harmless and can be cleaned on a later run.
            }
        }
        return renamed;
    }

    private static string SanitizeLookupName(string value)
    {
    ...
    private static string LookupTableRole(string oldName, int index)
    {
        (string Token, string Role)[] roles =
        [
            ("Angle Valve Body", "Body"),
            ("Ball Valve Body", "Body"),
            ("Gate Body", "Body"),
            ("Butterfly", "Body"),
            ("Bonnet", "Bonnet"),
            ("Thr Fem Ends", "ThreadEnd"),
            ("Thread", "ThreadEnd"),
            ("Lever Handles", "LeverHandle"),
            ("T Handles", "THandle"),
            ("Round Handle", "RoundHandle"),
            ("Handwheel", "Handwheel"),
            ("Operator", "Operator"),
            ("Nut", "Nut"),
            ("Stem", "Stem"),
        ...
        string? role = roles
            .FirstOrDefault(item =>
                oldName.Contains(item.Token, StringComparison.OrdinalIgnoreCase))
            .Role;
        if (!string.IsNullOrWhiteSpace(role)) return role;

        string cleaned = Regex.Replace(oldName, @"^n_(GM|DS)_", "", RegexOptions.IgnoreCase);
        cleaned = Regex.Replace(cleaned, @"_Type\d+$", "", RegexOptions.IgnoreCase);
        cleaned = SanitizeLookupName(cleaned);
        return string.IsNullOrWhiteSpace(cleaned) ? $"Lookup{index}" : cleaned;
    }
